  ...
  <div class="mb-10">
    <div class="flex items-center justify-between mb-3">
      ...
      <div class="flex flex-col items-center flex-1">
        <div id="step-dot-<?php echo $num; ?>"
          class="w-9 h-9 rounded-full flex items-center justify-center text-sm font-bold border-2 transition-all duration-300
          <?php echo $num === 1 ? 'bg-brand-600 border-brand-500 text-white' : 'bg-gray-800 border-gray-700 text-gray-500'; ?>">
          <span id="step-dot-num-<?php echo $num; ?>"><?php echo $num; ?></span>
          <svg id="step-dot-check-<?php echo $num; ?>" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"/>
          </svg>
        </div>
        <span id="step-label-<?php echo $num; ?>" class="text-xs mt-1 <?php echo $num === 1 ? 'text-brand-400' : 'text-gray-600'; ?> hidden sm:block text-center"><?php echo $label; ?></span>
      </div>
      <?php if ($num < 5): ?>
      <div id="step-line-<?php echo $num; ?>" class="flex-1 h-0.5 bg-gray-800 mx-1 transition-all duration-500 max-w-[60px]"></div>
      <?php endif; ?>
      <?php endforeach; ?>
    </div>
  </div>
